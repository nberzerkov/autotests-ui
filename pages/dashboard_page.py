...
class DashboardPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.students_bar_chart = page.get_by_test_id("students-bar-chart")

        self.activities_title = page.get_by_test_id("activities-widget-title-text")
        self.activities_bar_chart = page.get_by_test_id("activities-line-chart")

        self.courses_title = page.get_by_test_id("courses-widget-title-text")
        self.courses_bar_chart = page.get_by_test_id("courses-pie-chart")

        self.scores_title = page.get_by_test_id("scores-widget-title-text")
        self.scores_bar_chart = page.get_by_test_id("scores-scatter-chart")
    ...
    def check_visible_students_chart(self):
        ...
        expect(self.students_bar_chart).to_be_visible()
